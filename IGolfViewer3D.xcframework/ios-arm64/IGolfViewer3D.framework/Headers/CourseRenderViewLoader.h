...
@property (nonatomic, strong, nullable) RockParams* rockParams;
...
-(void)setRocksEnabled:(RockSize*)smallRock mediumRock:(RockSize*)mediumRock bigRock:(RockSize*)bigRock;
-(void)setHeatmaps:(NSArray<HeatmapData*>*)heatmaps;

-(NSArray<HeatmapData*>*)getHeatmaps;
