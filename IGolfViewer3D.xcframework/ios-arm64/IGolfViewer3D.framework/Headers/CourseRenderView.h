...
@property (nonatomic, assign)   BOOL autoGreenView;
...
courseGPSVectorDetailsResponse:(NSDictionary *)courseGPSVectorDetailsResponse
   courseGPSDetailsResponse:(NSDictionary *)courseGPSDetailsResponse
   scorecardDetailsResponse:(NSDictionary *)scorecardDetailsResponse
   coursePinPositionDetailsResponse:(nullable NSDictionary *)coursePinPositionDetails
             elevationsData:(nullable NSDictionary *)elevationsData
...
rotateHoleOnLocationChanged:(BOOL)rotateHoleOnLocationChanged
        ...
        userLocationVisible:(BOOL)userLocationVisible
              autoGreenView:(BOOL)autoGreenView
               heatmapsData:(nullable NSArray<HeatmapData*>*)heatmapsData
                 rockParams:(nullable RockParams*) rockParams;

// Heatmap visibility control
@property (nonatomic, assign) BOOL drawHeatmaps;
- (void)setDrawHeatmaps:(BOOL)drawHeatmaps;
